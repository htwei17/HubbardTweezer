function [vecs, vals] = DVR_3D(xvals, yvals, zvals, BarexScal, BareyScal, BarezScal, parx, pary, parz, Nbands, potential)
    ...
    %This routine uses parity symmetries, with par='p' being even parity and par='m' being odd parity.
