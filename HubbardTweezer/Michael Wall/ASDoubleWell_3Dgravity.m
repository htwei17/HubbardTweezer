...
Hami = diag([vals(1), vals(2)]) / UnitsConstants.kHz;
...
%Interaction energy
U = InteractionFromLengthScale(w0, w0, zR, mass) * swaveintegral(wannierL, wannierL, dx, dy, dz) / UnitsConstants.kHz;
